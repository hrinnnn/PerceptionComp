...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_path",
        default="C:/Users/shaox/Desktop/thu/大二/大二暑假/AI/lbl_ai/final/videos/",
        type=str,
        help="Path to video files",
    )
    parser.add_argument(
        "--json_file",
        default="C:/Users/shaox/Desktop/thu/大二/大二暑假/AI/lbl_ai/final/questions/4in1.json",
        type=str,
        help="Path to test JSON",
    )
    parser.add_argument(
        "--output_path",
        default="C:/Users/shaox/Desktop/thu/大二/大二暑假/AI/lbl_ai/Gemini-2.5-Pro/",
        type=str,
