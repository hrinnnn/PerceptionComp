...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--json_file",
        default="/Users/jadeons/Desktop/project/research/PerceptionComp/PerceptionComp/winter_ques/4in1_new.json",
        type=str,
        help="Path to test JSON",
    )
    parser.add_argument(
        "--output_path",
        default="/Users/jadeons/Desktop/project/research/PerceptionComp/PerceptionComp/test_result_winter/doubao",
        type=str,
