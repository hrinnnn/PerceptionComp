...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name", default="gemini-3-pro-preview", type=str, help="Gemini model name"
    )
    parser.add_argument(
        "--api_key",
        default=None,
...
>>>>>>> 84620bc427e5015bfb0f86fa9e75f5e4e2cfebd0
    ...
    parser.add_argument(
        "--output_path",
<<<<<<< HEAD
        default="/Users/jadeons/Desktop/project/research/PerceptionComp/PerceptionComp/test_result_winter_2/gemini_3_pro",
=======
